...
let rec trans_obj : Sm5.obj -> Sonata.obj = function
  ...
  | Sm5.Fn (arg,command) -> Sonata.Fn (arg, trans' command @ [Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Z 1)); Sonata.SUB; Sonata.PUSH(Sonata.Id "#off"); Sonata.STORE; Sonata.PUSH(Sonata.Id "#ret"); Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.ADD; Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Unit)); Sonata.MALLOC; Sonata.CALL])
...
and trans' : Sm5.command -> Sonata.command = function
  ...
  | Sm5.CALL :: cmds -> [Sonata.PUSH(Sonata.Fn("#p",[Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Z 0)); Sonata.EQ; Sonata.JTR([Sonata.UNBIND; Sonata.POP] @ trans' cmds,[Sonata.UNBIND; Sonata.POP] @ trans' cmds @ [Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Z 1)); Sonata.SUB; Sonata.PUSH(Sonata.Id "#off"); Sonata.STORE; Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.PUSH(Sonata.Id "#ret"); Sonata.ADD; Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Unit)); Sonata.MALLOC; Sonata.CALL])])); Sonata.PUSH(Sonata.Id "#ret"); Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.ADD; Sonata.STORE; Sonata.PUSH(Sonata.Id "#off"); Sonata.LOAD; Sonata.PUSH(Sonata.Val(Sonata.Z 1)); Sonata.ADD; Sonata.PUSH(Sonata.Id "#off"); Sonata.STORE; Sonata.CALL]
...
let trans : Sm5.command -> Sonata.command = fun command -> 
    [Sonata.MALLOC; Sonata.BIND "#ret"; Sonata.MALLOC; Sonata.BIND "#off"; Sonata.PUSH (Sonata.Val(Sonata.Z (0))); Sonata.PUSH(Sonata.Id "#off"); Sonata.STORE] @ trans' command
